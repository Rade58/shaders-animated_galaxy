...
//                  handling the color without `mix` ------

// instead of doing mix, we will set strength to be value for alpha
// and just use vColor instead of mixedColor

// you also need to activate transparency on the ShaderMaterial
// I once explain that we need to do this if you want to have
// transparency nuances and not just transparent and opaque
// I guese without it value you pass gets clamped to 1.0 or 0.0

// in terms of performances it will be fine
// ------------------------------------------------------
