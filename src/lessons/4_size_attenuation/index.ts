...
// ------ size attenuation ------
//
// I guess this will allow us to see particles that are close to the camera

// we used it on PointsMaterial, but npw we need to apply this on our own

// and we are going to get the formula, or code from
// threejs shader
// so we are going to go to:
// node_modules/three/src/renderers/shaders/ShaderLib/points.glsl.js
// search for "USE_SIZEATTENUATION" and copy the piece of code
// that is encapsulated in    `#ifdef`
...
// mvPosition stands for modelView

// it cotrresponds to the position of the vertex once the modelMatrix
// and the viewMatrix have been applied
// In our case it's our viewPosition variable
