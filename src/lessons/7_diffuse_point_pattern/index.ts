...
// ------------------------------------------------------
// ------ drawing our particle pattern: diffuse point pattern ------
//

// some helpfull patterns we did in some earlier workshop:
// I think this is the one is similar to one we want to define
// https://github.com/Rade58/FragmentShaders-PatternsPlayground/blob/main/src/patterns/46_small_central_gradient_circle/fragment.glsl
