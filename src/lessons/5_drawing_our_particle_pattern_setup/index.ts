...
//
// we are going to draw a pattern instead of square particles
// but first let's explain what are we going to use

// we cannot send the uv as a varying because each vertex is
// a particle but we can use `gl_PointCoord` inside the fragment shader
// gl_PointCoord is vec2
// ------------------------------------------------------
