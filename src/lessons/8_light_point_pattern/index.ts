...
// ------------------------------------------------------
// ------ drawing our particle pattern: light point pattern ------

// in this pattern we use `pow` (power function)
// and we do this after inversion
// and it will be power of 10.0

// some helpfull patterns we did in some earlier workshop:
// https://github.com/Rade58/FragmentShaders-PatternsPlayground

// we will also increase uSize when passing it as uniform
// from threejs; or to be precise in our case we can just
// increase uSize to the 30 in our parameters
// and in gui setting, we can increase that maximum can be 30

// indeed this can be bad for performances but we will do it
// like I mentioned
// ------------------------------------------------------
