...
// Remove the randomness from the position attribute,
//  save it in a new attribute named aRandomness,
//  apply it after rotating the stars in the vertex
// shader

// we added those in workshop about glaxy generator
// they are randomX/Y/Z
//
// ------------------------------------------------------
  ...
  function generateGalaxy(/* renderer: THREE.WebGLRenderer */) {
    ...
    for (let i = 0; i < parameters.count; i++) {
      ...
      const randomZ =
        ...
        parameters.randomness *
        radius;
      // and we are not using them so I comment them out
      positions[i3 + 0] =
      ...
      // we are adding them here instead
    ...
    // setting new attribute called `aRandomness`
