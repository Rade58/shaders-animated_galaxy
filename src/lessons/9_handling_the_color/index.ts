...
// ------------------------------------------------------
// ------ drawing our particle pattern: handling the color ------

// to retreive the color we should have written something
// like this inside vertex shader
// `attribute vec3 color;`
// but it is already defined and we will get an error if we try
// to redeclare it because we use ShaderMaterial and not
// the RawShaderMaterial

// we will just assign it to varyinf vColor we will declare
// in vertex shader

// and then we will use varying vColor inside fragment shader
// we wwill use it exactly with mix function like we did
// in patterns in one of previous workshop
